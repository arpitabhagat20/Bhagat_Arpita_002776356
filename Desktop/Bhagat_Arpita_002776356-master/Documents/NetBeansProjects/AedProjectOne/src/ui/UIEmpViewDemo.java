 ...
 * @author arpitabhagat
 */
public class UIEmpViewDemo extends javax.swing.JPanel {

    /**
     * Creates new form UIEmoView
     */
    EmpView register;
    public UIEmpViewDemo(EmpView register) {
        initComponents();
    ...
    private void viewImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewImageActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tblEmployee.getModel();
        EmpCreate selectedEmployee = (EmpCreate)model.getValueAt(selectedRowIndex, 0);
        JobImageDisplay.setIcon(new ImageIcon(selectedEmployee.getImg()));
