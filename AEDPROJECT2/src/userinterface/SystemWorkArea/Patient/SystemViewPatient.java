    ...
    private void populateData() {
        try{
            ...
            if(x!=null && !x.isEmpty())
            {
                ...
                {patient,patient.getName(),patient.getCellPhoneNumber(),patient.getAge(),patient.getHeight(),patient.getWeight(), patient.getEmailId(),patient.getCellPhoneNumber(),patient.getHouse().getHouseNum()+" "+ patient.getHouse().getStreet(),city,community});
